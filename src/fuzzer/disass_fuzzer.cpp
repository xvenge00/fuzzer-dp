...
DisassociationFuzzer::DisassociationFuzzer(mac_t src_mac, mac_t fuzzed_device_mac):
    Fuzzer(src_mac, fuzzed_device_mac){}

generator<fuzz_t> DisassociationFuzzer::get_mutated() {
...
generator<fuzz_t> DisassociationFuzzer::get_mutated_content() {
...
size_t DisassociationFuzzer::num_mutations() {
